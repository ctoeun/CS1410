...
public class SpeedTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("DynamicArray took " + String.format("%.7f", (endTime - startTime) / 1000000000.0) + 
		...
		System.out.println("DynamicArray2 took " + String.format("%.7f", (endTime - startTime) / 1000000000.0) + 
				" sec to add " + N + " elements.");
	}
