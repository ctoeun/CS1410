...
public class Robber extends Actor {
	...
	public Robber(Double startingPosition, Double initHitbox, BufferedImage img, int health, int coolDown, double speed,
			int attackDamage) {
	...
	public void setCollisionStatus(Actor other) {
		if (other instanceof Cop && this.isCollidingOther(other))
			setColliding(true);
		if (other instanceof FatCop && this.isCollidingOther(other))
		setColliding(true);
	}
	...
	public void attack(Actor other) {
		if (other instanceof Cop) {
			super.attack(other);
		}
		if (other instanceof FatCop) {
			super.attack(other);
		}
	}
