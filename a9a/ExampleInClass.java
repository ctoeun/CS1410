...
public class ExampleInClass extends JPanel implements ActionListener {
	...
	public ExampleInClass() {
		...
		Cop plant = new Cop(new Point2D.Double(200.0, 200.0), new Point2D.Double(plantImage.getWidth(), plantImage.getHeight()), plantImage, 100, 5, 1);
		Robber zombie = new Robber(new Point2D.Double(500.0, 200.0), new Point2D.Double(zombieImage.getWidth(), zombieImage.getHeight()), zombieImage, 100, 50, -2, 10);
